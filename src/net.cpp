...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XPDz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "xpdz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "xpdz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.xpdz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.xpdz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XPDz is probably already running."), addrBind.ToString().c_str());
        else
