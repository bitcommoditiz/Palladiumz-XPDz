...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 18); // XPDz: starting difficulty is 1 / 2^10
...
double nUnderlyingBirthValue = 757; //the value of the underlying commodity in US Dollar the date the bitcommoditiz was born
